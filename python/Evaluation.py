...
if __name__ == "__main__":
    ...
    #The golddf and predictdf should be the same set, except that predictdf's relevance_int is your predicted relevances and they should be using same scoring scale as golddf
